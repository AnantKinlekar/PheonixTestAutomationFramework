...
public class CreateJobAPIWithDBValidationWithResponseModelTest {
    ...
    public void setup() {
        ...
        customerProduct = new CustomerProduct(getTimeWithDaysAgo(1), "25892930457678", "25892930457678", "25892930457678", getTimeWithDaysAgo(1), Product.NEXUS_2.getCode(), Model.NEXUS_2_BLUE.getCode());
